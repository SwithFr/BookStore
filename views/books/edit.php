...
<div class="section">
    ...
    <?php endif; ?>
        ...
        <textarea class="form__textarea"
                  name="summary"
                  id="summary"><?= $data['d']['summary']; ?></textarea>
        ...
        <select class="form__input"
            ...
            <?php foreach ($data['authors'] as $author): ?>
                <option <?= ($data['d']['author_id'] == $author->id) ? 'selected="selected"' : '' ?>
        ...
        <select class="form__input"
            ...
            <?php foreach ($data['genres'] as $genre): ?>
                <option <?= ($data['d']['genre_id'] == $genre->id) ? 'selected="selected"' : '' ?>
        ...
        <select class="form__input"
            ...
            <?php foreach ($data['languages'] as $language): ?>
                <option <?= ($data['d']['language_id'] == $language->id) ? 'selected="selected"' : ''; ?>
        ...
        <select class="form__input"
            ...
            <?php foreach ($data['editors'] as $editor): ?>
                <option <?= ($data['d']['editor_id'] == $editor->id) ? 'selected="selected"' : '' ?>
        ...
        <select class="form__input"
            ...
            <?php foreach ($data['locations'] as $location): ?>
                <option <?= ($data['d']['location_id'] == $location->id) ? 'selected="selected"' : '' ?>

<div class="section">
    ...
    <form class="form--add" action="<?= Html::url('add', 'book'); ?>" method="post" enctype="multipart/form-data">
        ...
        <input class="form__input form__input--large" type="file" name="img" id="img"
        ...
        <textarea class="form__textarea" name="summary"
    ...
    <a class="btn btn--add btn--inline btn--small" href="<?= Html::url('add', 'location'); ?>">Ajouter un
        emplacement</a>
</div>
<div class="section">
    ...
    <form class="form--register" action="<?= Html::url('register','user'); ?>" method="post">
        ...
        <input class="form__input form__input--large" type="text" name="login" id="login" value="<?= isset($_POST['login']) ? $_POST['login'] : ''; ?>"/>
        <label class="form__label" for="email">Email</label>
        <?= isset($data['errors']['email']) ? '<span class="has-error">' . $data['errors']['email'] . '</span>' : ''; ?></span>
        <input class="form__input form__input--large" type="email" name="email" id="email" value="<?= isset($_POST['email']) ? $_POST['email'] : ''; ?>"/>

...
<div class="section">
    ...
    <form class="form--add" action="<?= Html::url('edit', 'user', ['id' => Session::getId()]); ?>" method="post">
        ...
        <label class="form__label" for="chgPassword">Changez votre mot de passe <span class="section__block__infos">(laissez vide si vous ne voulez pas changer)</span>
            :</label>
